...
4. `P1-TASK-20260524-0032-player-resource-logistics-delivery-loop.md` - make player resource purchases create shipments/reservations before inventory becomes usable.
5. `P1-TASK-20260524-0033-player-margin-accounting.md` - track input cost, production quantity, retail revenue, gross margin, and simple profit/loss for player operations.
